...
import { Lock, Mail, ArrowRight, Shield, Zap, Globe } from 'lucide-react'
          ...
          <div className='hidden lg:block space-y-8'>
            <div className='space-y-6'>
              ...
              <p className='text-lg text-slate-600 leading-relaxed'>
                Empower everyone in your business to securely automate their work in minutes, not months—no coding required.
              </p>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-center space-x-3'>
                ...
                <span className='text-slate-700'>Connect 5000+ apps seamlessly</span>
              </div>
              <div className='flex items-center space-x-3'>
                <div className='bg-purple-100 p-2 rounded-full'>
                  <Zap className='w-5 h-5 text-purple-600' />
                </div>
                <span className='text-slate-700'>Lightning-fast automation</span>
              </div>
            </div>

            <button className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg">
